...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-account_payment_redsys',
    download_url='https://github.com:nantic/trytond-account_payment_redsys.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-account_payment_redsys.git'
    },
    classifiers=[
